...
export const Contact = () => {
  ...
  const [submitPhase, setSubmitPhase] = useState('idle'); // 'idle' | 'encrypting' | 'uploading' | 'delivered'
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate cryptographic delay for premium aesthetic
    await new Promise((r) => setTimeout(r, 700));
    setSubmitPhase('uploading');
    await new Promise((r) => setTimeout(r, 400));

    try {
      const response = await fetch("https://formsubmit.co/ajax/rajpurohitabhijit543@gmail.com", {
        method: "POST",
        headers: { 
      ...
      setErrors((prev) => ({ ...prev, submit: 'Failed to deliver message. Please retry.' }));
    } finally {
  ...
  return (
    <section id="contact" className="py-24 px-6 max-w-7xl mx-auto relative overflow-hidden">
      <ScrollReveal>
        ...
        {/* Decorative Orbs */}
        <div className="absolute top-10 right-0 w-36 h-36 bg-purple-500/5 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute bottom-5 left-0 w-32 h-32 bg-cyan-500/5 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:rajpurohitabhijit543@gmail.com" className="text-sm font-bold text-slate-700 dark:text-slate-300 hover:text-purple-500 dark:hover:text-purple-400 transition-colors">
            ...
            {/* Micro-Illustration */}
            <div className="hidden lg:block relative w-full h-48 bg-slate-100/40 dark:bg-slate-950/20 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden p-6 select-none shadow-md">
              <svg className="w-full h-full opacity-70" viewBox="0 0 400 200" fill="none">
                <rect x="50" y="40" width="90" height="120" rx="10" className="fill-slate-100 dark:fill-slate-900 stroke-purple-500/30" strokeWidth="2" />
                <rect x="260" y="40" width="90" height="120" rx="10" className="fill-slate-100 dark:fill-slate-900 stroke-purple-500/30" strokeWidth="2" />
                <circle cx="95" cy="100" r="16" className="fill-purple-500/10 stroke-purple-500/40" strokeWidth="2" />
                <circle cx="305" cy="100" r="16" className="fill-purple-500/10 stroke-purple-500/40" strokeWidth="2" />
