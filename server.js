  ...
  try {
    ...
    const response = await fetch(formSubmitUrl, {
      ...
      body: JSON.stringify({
        ...
        _autoresponse: `Thank you for contacting me, ${name}. I have successfully received your message and will review it carefully. I typically respond within 24-48 hours. Best Regards, Abhijit Rajpurohit.`
      })
    });
